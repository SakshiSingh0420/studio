    ...
    <div className="space-y-8">
        ...
        <Dialog open={isAdding} onOpenChange={setIsAdding}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            <DialogHeader>
              ...
              <CardDescription>Define core geopolitical identity and classification.</CardDescription>
            </DialogHeader>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filtered.map(country => (
          <Card key={country.id} className="metric-card overflow-hidden border-2 hover:border-primary transition-all group relative bg-white">
